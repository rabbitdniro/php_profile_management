...
// No need to fetch profile details for changing password
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $newPassword = $_POST['updated-password'];
  $confirmNewPassword = $_POST['confirm-updated-password'];
  ...
  if (empty($errors)) {
    ...
    $success = $profileManager->updateProfilePassword($profileId, $hashedNewPassword);
    ...
    <aside class="lg:w-64 bg-white shadow-lg z-10 lg:h-screen lg:sticky lg:top-0">
      ...
      <div class="p-4">
        <nav class="space-y-1">
          ...
          <a href="./change-password.php" class="flex items-center space-x-3 p-3 rounded-lg sidebar-link active">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-5 h-5 text-gray-500">
              <path stroke-linecap="round" stroke-linejoin="round"
              ...
              <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input type="password" name="updated-password" required
                      class="w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300"
                      placeholder="••••••••" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input type="password" name="confirm-updated-password" required
                      class="w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300"
                      placeholder="••••••••" />
                  </div>
                </div>
