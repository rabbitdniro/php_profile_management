...
<head>
    ...
    <title>Forgot Password | Interactive Cares</title>
...
<body class="bg-gradient-to-br from-indigo-50 via-white to-cyan-50 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full space-y-8">
        <div class="text-center animate-float">
            ...
            <p class="mt-2 text-gray-600">Use your email to reset your password</p>
        </div>
                    ...
                    <div class="relative">
                        ...
                        if (!empty($errors)) {
                            foreach ($errors as $error) {
                                if (str_contains($error, 'valid email')) {
                                    echo '<span class="mt-2 text-sm text-red-600">' . htmlspecialchars($error) . '</span>';
                                } elseif (str_contains($error, 'account found')) {
                                    echo '<span class="mt-2 text-sm text-red-600">' . htmlspecialchars($error) . '</span>';
                                }
                            }
                        }
