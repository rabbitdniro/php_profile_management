    ...
    <main class="flex-1 p-6 lg:p-8">
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
        <div>
          ...
          <p class="text-gray-600">Welcome back, <?php echo htmlspecialchars($profile['full_name']); ?>!</p>
        </div>
          ...
          <div class="p-6">
            <div class="flex flex-col md:flex-row md:items-center">
              ...
              <div class="mt-4 md:mt-0 md:ml-6 flex-1">
                <h3 class="text-xl font-bold text-gray-800"><?php echo htmlspecialchars($profile['full_name']); ?></h3>
              </div>
            </div>
