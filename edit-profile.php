...
// Initialize ProfileManager and get current profile
$profileManager = new ProfileManager();
$profileId = $_SESSION['profile_id'];

$profile = $profileManager->findProfileById($profileId);
if (!$profile) {
  header('Location: login.php');
  exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  $updatedName = htmlspecialchars(trim($_POST['updated-name']));
  $updatedEmail = htmlspecialchars(trim($_POST['updated-email']));
  ...
  $message = $profileManager->updateProfile($profileId, $updatedProfile);
    ...
    <main class="flex-1 p-6 lg:p-8">
      ...
      <div class="max-w-4xl">
              ...
              <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input type="email" name="updated-email" value="<?php echo htmlspecialchars($profile['email']); ?>"
                      class="w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300"
        ...
        <?php if (isset($message)): ?>
          <div
            class="mt-6 p-4 bg-green-100 border border-green-200 text-green-800 rounded-lg text-center font-medium animate-fadeIn">
